...
(function (angular) {
    ...
    angular.module('Condo').
        ...
        factory('Condo.Google', ['$q', 'Condo.Md5', '$window', function ($q, md5, $window) {
            var PENDING = 0,
                STARTED = 1,
                PAUSED = 2,
                UPLOADING = 3,
                    ...
                    var self = this,
                        ...
                        build_request = function (chunk) {
                            return md5.hash(chunk).then(function (val) {
                                return {
                                    data: chunk,
                                    data_id: $window.btoa(hexToBin(val))
                                };
                            }, function (reason) {
        ...
        .run(['Condo.Google', 'Condo.Api', function (google, api) {
            api.register('GoogleCloudStorage', google);
        }]);
