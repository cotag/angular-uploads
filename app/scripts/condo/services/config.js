...
(function (angular) {
	...
	angular.module('Condo').
		provider('Condo.Config', function() {
			...
			// Controller options
			//
			this.endpoint = '/uploads';		// API endpoint path
			...
			this.supress_notifications = false;	// this prevents js alerts about warnings and errors if you are observing these yourself


			//
			// Location of hashing assets
			//
			this.md5_worker = '/scripts/condo-hash-worker.js';
			this.md5_emulated_worker = '/scripts/condo-hash-worker-emulator.js';
			...
			this.$get = function() {
				...
				return {
					...
					md5_worker: self.md5_worker,
					md5_emulated_worker: self.md5_emulated_worker
				};
			};
		});
